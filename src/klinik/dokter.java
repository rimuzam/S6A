...
public class dokter extends javax.swing.JFrame {
    ...
    protected void datatable(){
        Object[] Baris ={"No Identitas","Nama Dokter","Jenis Kelamin","Alamat","Golongan Darah"};
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        // TODO add your handling code here:
         try {
            String sql = "update dokter set nama=?,jk=?,alamat=?,goldar=? where id =?";
            PreparedStatement stat = conn.prepareStatement(sql);
    ...
    private void bdeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bdeleteActionPerformed
        ...
        if (ok==0) {
            String sql ="delete from dokter where id='"+tid.getText()+"'";
            try {
                PreparedStatement stat = conn.prepareStatement (sql);
                stat.executeUpdate();
